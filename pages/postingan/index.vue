    ...
    <b-row class="justify-content-center">   
      <b-col lg="12" class="mb-4">
        <div class="br-100 btn-group bg-white" role="group" aria-label="Button group with nested dropdown">
          <NuxtLink to="/postingan" class="br-100 btn btn-ui-primary">Pelamar</NuxtLink>
          <NuxtLink to="/postingan/pekerja" class="br-100 btn btn-white">Pekerja</NuxtLink>
        </div>
      </b-col>
      <b-col lg="12" class="mb-4">
            ...
            <b-col cols="3">
              <b-row>
                ...
                <b-col cols="auto" class="pt-1">
                  <strong class="page-title text-ui-primary">Postingan Pelamar</strong>
                </b-col>
              </b-row>
            </b-col>
...
export default {
  data() {
    return {
      fields: [
        ...
        { key: 'payment_type', label: 'Satuan' },
        { key: 'job_start_date', label: 'Tanggal Mulai' },
        { key: 'location_province', label: 'Provinsi' },
        { key: 'location_city', label: 'Kota/Kabupaten' },
        { key: 'location_subdistrict', label: 'Kecamatan' },
        { key: 'location_village', label: 'Kelurahan' },
        { key: 'location_zipcode', label: 'Kode POS' },
        { key: 'location_detail', label: 'Alamat' },
  ...
  methods: {
    ...
    async getThreads(){
      await this.$axios.$get(`/thread?offset=${(this.currentPage - 1) * this.limit}&limit=${this.limit}&search=${this.search}&type=Seeker`).then((res) => {
