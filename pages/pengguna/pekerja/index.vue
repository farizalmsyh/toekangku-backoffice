    ...
    <b-row class="justify-content-center">   
      <b-col lg="12" class="mb-4">
        <div class="br-100 btn-group bg-white" role="group" aria-label="Button group with nested dropdown">
          <NuxtLink to="/pengguna" class="br-100 btn btn-white">Internal</NuxtLink>
          <NuxtLink to="/pengguna/pekerja" class="br-100 btn btn-ui-primary">Pekerja</NuxtLink>
            ...
            <b-col lg="3" class="mb-2">
              <b-row>
                ...
                <b-col cols="auto" class="pt-1">
                  <strong class="page-title text-ui-primary">Pengguna - Pekerja</strong>
                </b-col>
              </b-row>
            </b-col>
...
export default {
  data() {
    return {
      fields: [
        ...
        { key: 'profesion', label: 'Profesi' },
        { key: 'start_year', label: 'Tahun Mulai Kerja' },
  ...
  methods: {
    ...
    async getUsers(){
      await this.$axios.$get(`/user?offset=${(this.currentPage - 1) * this.limit}&limit=${this.limit}&search=${this.search}&type=Pekerja`).then((res) => {
