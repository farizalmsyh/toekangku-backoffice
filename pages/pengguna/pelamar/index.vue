    ...
    <b-row class="justify-content-center">   
      <b-col lg="12" class="mb-4">
        <div class="br-100 btn-group bg-white" role="group" aria-label="Button group with nested dropdown">
          ...
          <NuxtLink to="/pengguna/pelamar" class="br-100 btn btn-ui-primary">Pelamar</NuxtLink>
        </div>
      </b-col>
      <b-col lg="12" class="mb-4">
            ...
            <b-col lg="3" class="mb-2">
              <b-row>
                ...
                <b-col cols="auto" class="pt-1">
                  <strong class="page-title text-ui-primary">Pengguna - Pelamar</strong>
                </b-col>
              </b-row>
            </b-col>
...
export default {
  ...
  methods: {
    ...
    async getUsers(){
      await this.$axios.$get(`/user?offset=${(this.currentPage - 1) * this.limit}&limit=${this.limit}&search=${this.search}&type=Pengguna`).then((res) => {
